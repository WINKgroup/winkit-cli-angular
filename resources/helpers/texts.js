...
const dynamicTexts = {
    ...
    updateMethod: name => [`Would you like to update the Server${name} model automatically using default property name associations or manually map property names (to still use a default name skip a prompt by pressing Enter/Return)?`, ''],
